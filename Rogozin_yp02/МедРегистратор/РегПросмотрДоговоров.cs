...
{
    public partial class РегПросмотрДоговоров : Form
    {
        ...
        private void РегПросмотрДоговоров_Load(object sender, EventArgs e)
        {
            /*Загрузка таблицы Договора*/
            //string query0 = "SELECT * FROM договора WHERE дата = CURDATE();";
            string query0 = "SELECT * FROM договора WHERE дата = DATE(NOW());";
