...
{
    public partial class РасходВакцинГод : Form
    {
        ...
        public РасходВакцинГод()
        {
            InitializeComponent();
            conn.Open();
        }

        private void РасходВакцинГод_Load(object sender, EventArgs e)
        {
        ...
        private readonly string YslygiZaGod = @"C:\Users\Mighty kitten\Desktop\Для уп\Вакц\Вакц за год.docx";
