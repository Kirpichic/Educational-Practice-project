...
{
    public partial class ОказанныеУслугиГод : Form
    {
        ...
        public ОказанныеУслугиГод()
        {
            InitializeComponent();
            conn.Open();
        }

        private void ОказанныеУслугиГод_Load(object sender, EventArgs e)
        {
        ...
        private readonly string YslygiZaGod = @"C:\Users\Mighty kitten\Desktop\Для уп\Оказаные услуги\Оказанные услуги за год.docx";
