...
{
    public partial class ОказанныеУслугиМесяц : Form
    {
        ...
        public ОказанныеУслугиМесяц()
        {
            InitializeComponent();
            conn.Open();
        }
        
        private void ОказанныеУслугиМесяц_Load(object sender, EventArgs e)
        {
        ...
        private readonly string YslygiZaGod = @"C:\Users\Mighty kitten\Desktop\Для уп\Оказаные услуги\Оказанные услуги за месяц.docx";
