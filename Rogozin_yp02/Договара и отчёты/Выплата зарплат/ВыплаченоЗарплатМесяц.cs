...
{
    public partial class ВыплаченоЗарплатМесяц : Form
    {
        ...
        public ВыплаченоЗарплатМесяц()
        {
            InitializeComponent();
            conn.Open();
        }

        private void ВыплаченоЗарплатМесяц_Load(object sender, EventArgs e)
        {
        ...
        private readonly string YslygiZaGod = @"C:\Users\Mighty kitten\Desktop\Для уп\ЗП\зп за месяц.docx";
